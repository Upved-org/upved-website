...
const programs = [
  {
    ...
    image: "/group-hiking-nature-trail-morning-sunshine.webp",
  ...
  },
  {
    ...
    image: "/people-throwing-ball-sky-outdoor-sports.webp",
  ...
  },
  {
    ...
    image: "/youth-sports-kids-playing-outdoor-field.webp",
    comingSoon: true,
    cta: "Coming Soon",
  },
]
          ...
          {programs.map((program) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="mt-6">
                  {program.comingSoon ? (
                    <span className="inline-flex items-center justify-center rounded-md border border-border px-5 py-2 text-sm font-medium text-muted-foreground shadow-sm">
                      Coming Soon
                    </span>
                  ) : program.external ? (
                    <a
                      ...
                      className="inline-flex items-center justify-center gap-2 rounded-md border border-primary px-5 py-2 text-sm font-medium text-primary transition-colors hover:bg-primary hover:text-primary-foreground shadow-sm"
                    >
                      {program.cta}
                    ...
                    <Link
                      href={program.href || "#"}
                      className="inline-flex items-center justify-center rounded-md border border-primary px-5 py-2 text-sm font-medium text-primary transition-colors hover:bg-primary hover:text-primary-foreground shadow-sm"
                    >
                      {program.cta}
                    </Link>
                  )}
